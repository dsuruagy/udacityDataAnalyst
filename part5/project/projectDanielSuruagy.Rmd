...
0.76. Finally, total.sulfur.dioxide has a positive correlation with density,
with a value of positive 0.62.
...
Here it is expected that the higher the PH, the higher the total amount of SO² 
