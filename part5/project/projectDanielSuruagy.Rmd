...
```{r echo=FALSE, , message=FALSE, warning=FALSE, Correlation matrices}
...
#ggpairs(data=wine_quality, mapping=ggplot2::aes(colour = quality),
#        legend = 1,
...
.total.sulfur.dioxide x alcohol ++
...
#+
#  xlim(0, quantile(wine_quality$residual.sugar, 0.99))
