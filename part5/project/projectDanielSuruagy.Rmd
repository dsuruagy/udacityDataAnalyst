...
The quantity of residual sugar does not have strong influence on grades. 
Grades above 8 are given to wines with lower densities and less sugar, but it
can happen with grade 6 also, were falls great part of data. I could not identify
...
grades, appear on the lower left part of this plot, where the values for
chlorides and density are lower. Because there are fewer grades above 8 than 
...
Best quality grades were given to wines which presentes lower densities and 
greater alcohol quantity. It is true for grades above 8, but again these values
can happen for grades 6 or less. It is not a strong pattern too.
...
The multivariate plots provides another way to see what could be observed on
bivariate analysis: the stronger relationship between density and residual 
sugar. I've tried to relate the most 
