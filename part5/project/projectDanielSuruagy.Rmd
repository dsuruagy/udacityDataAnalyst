...
Alcohol content in wines can be in the range of 5.5% to 23% [12]. In this 
sample, they fall in the 8% to 14.2%.
...
scores. This distribution is normal, with a median of 6.

I wonder why most of wines received a score of 5 or 6. What chemical 
characteristics could explain these scores?
...
correlation, the free sulfur correlates with the total sulfur dioxide quantity.
...
alcohol median value, the higher the score. These can be seen on the violin
plot, which surprisingly present a cup of wine for the highest score!
